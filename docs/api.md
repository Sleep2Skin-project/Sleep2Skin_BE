...
>
> **최종 갱신** 2026-08-14 — `todo` 2개 상세 규격 반영 (§2.4) · `user` 3개 구현 반영 (§2.1)
...
**다섯 개 전부 구현 완료** (3·4·5는 2026-08-14).
...
**1단계 6개는 전부 끝났다.** 이어서 `GET /skin/verification/summary`(HOME-09) · `GET /skin/model`(REP-12) · **`todo` 2개**(§2.4) · **`user` 3·4·5번**(§2.1)까지 끝났다. **남은 것은 `report` 5개뿐이다.**
